...
urlpatterns = [
    ...
    path('update-status/<str:pk>', StatusUpdateView.as_view(), name='update-status'),
    path('create-po/', create_po, name='create-po'),
    path('preview-po/<str:pk>', po_view.as_view(), name='preview-po'),
    path('delete-purchase-order/<str:pk>', PurchaseOrderDeleteView.as_view(), name="delete-purchase-order"),
