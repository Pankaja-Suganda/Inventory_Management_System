# Generated by Django 2.2.10 on 2021-11-20 17:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('so_pdf', models.FileField(blank=True, null=True, upload_to='core/static/assets/documents/Pre sales order/')),
                ...
                ('product_ids', models.ManyToManyField(blank=True, null=True, to='pre_sales_order.PProduct')),
        ...
        migrations.AddField(
            model_name='pproduct',
            name='so_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='pre_sales_order.PreSalesOrder'),
        ),
    ]
